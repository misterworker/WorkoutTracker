...
class WorkoutExerciseAdapter(
    ...
    private val onCheckboxChecked: (WorkoutExercise) -> Unit,
    private val context: Context
) : ListAdapter<WorkoutExercise, WorkoutExerciseAdapter.WorkoutExerciseViewHolder>
        ...
        val setAdapter = SetAdapter(
            ...
            object : SetAdapter.OnSetChangeListener {
                ...
                override fun onSetCompletionChanged(setIndex: Int, isComplete: Boolean) {
                    ...
                    if (isComplete && workoutExercise.sets[setIndex] != "W") {
