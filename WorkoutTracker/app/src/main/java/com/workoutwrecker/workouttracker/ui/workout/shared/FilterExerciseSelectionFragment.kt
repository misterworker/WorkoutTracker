...
class FilterExercisesSelectionFragment : Fragment() {

    private var _binding: FragmentFilterExercisesSelectionBinding? = null
    private val binding get() = _binding!!
    private val args: FilterExercisesSelectionFragmentArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        doneButton.setOnClickListener {
            ...
            val selectedExercises = args.selectedExercises?.toList() ?: emptyList()
            val bundle = Bundle().apply {
                putParcelableArray("selectedExercises", selectedExercises.toTypedArray())
                putStringArray("selectedTypes", selectedFilterTypes.toTypedArray())
                putStringArray("selectedBodyParts", selectedFilterBodyParts.toTypedArray())
